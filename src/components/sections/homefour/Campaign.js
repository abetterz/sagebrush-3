...
import featured from '../../../assets/img/shop/featured.jpg';
...
const fundcampaingposts = [
    { img: "assets/img/shop/featured4.jpg", badge: "Finance", title: "Help for Children of the East" },
    { img: "assets/img/shop/featured3.jpg", badge: "Finance", title: "Help for Children of the East" }
];
                            ...
                            <div key={i} className="col-lg-6 col-md-12">
                                <div className="story-wrapper">
                                    ...
                                    <div className="story-box-content story-content-wrapper">
                                        <span className="story-badge bg-custom-secondary text-color-primary">{item.badge}</span>
